...
import { getBibleTriviaQuestions, getGeneralTriviaQuestions, getTriviaQuestions } from '@/lib/trivia-questions';
import {
  Card,
  CardContent,
  CardDescription,
...
const GertPage: React.FC = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const questionsData = await getBibleTriviaQuestions();
