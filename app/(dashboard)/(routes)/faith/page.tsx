...
import { getFaithQuestions, getMomQuestions, getTriviaQuestions, getZariQuestions } from '@/lib/trivia-questions';
import {
  Card,
  CardContent,
  CardDescription,
...
const GertPage: React.FC = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const questionsData = await getFaithQuestions();
    ...
    <div className="px-5 py-10 text-white select-none">
      ...
      <div className="mb-4 space-y-2 select-none">
        ...
        <p className="text-zinc-500 font-medium text-sm md:text-lg text-center">
          Play, Win, Repeat on Faith Trivia!
        </p>
