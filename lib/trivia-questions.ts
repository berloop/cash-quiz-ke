...
export const getTriviaQuestions = async () => {
  ...
  export const getGeneralTriviaQuestions = async () => {
    try {
      const response = await fetch('/api/trivia'); // Fetch data from the API route
      if (response.ok) {
        const questions = await response.json();
        console.log(questions);
        return questions;
  ...
  export const getBibleTriviaQuestions = async () => {
    try {
      const response = await fetch('/api/bible'); // Fetch data from the API route
      if (response.ok) {
        const questions = await response.json();
        console.log(questions);
        return questions;
